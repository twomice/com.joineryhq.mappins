 ...
 */
class CRM_Mappins_Upgrader_Base {

  /**
   * @var CRM_Mappins_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Mappins_Upgrader(
        'com.joineryhq.mappins',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Mappins_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Mappins_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
